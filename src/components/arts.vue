<template>
  <div class="works-container">
    <div class="title">
      ...
      <img class="line" src="../../static/image/pink-line.png" alt="">
    ...
    <div class="main-section">
      ...
      <div class="section-container">
        <div class="section-title">
          <span>课程详解 <span class="eng">Course Details</span></span>
          <img src="../../static/icon/right-bottom-arrow.svg" alt="">
        </div>
...
.works-container {
  font-family: "HYQihei";
  background: linear-gradient(180deg, #FFFFFF 0%, #F4F4F4 51.04%, #E83468 100%);
  color: black;
  text-align: left;
  max-height: 100%;
  overflow-y: scroll;
      ...
      .lesson-list {
        ...
        .lesson-ele {
          ...
          .ele-bg {
            ...
            .mask {
              background: linear-gradient(180deg, transparent 0%, transparent 71.04%, #E83468 100%);
              position: absolute;
              top: 0;
              position: absolute;
              opacity: 0;
