<template>
  <div class="works-container">
    <div class="title">
      ...
      <img class="line" src="../../static/image/blue-line.png" alt="">
...
.works-container {
  background: linear-gradient(180deg, #FFFFFF 0%, #F4F4F4 51.04%, #5482A3 100%);
  color: black;
  text-align: left;
  max-height: 100%;
  overflow-y: scroll;
      ...
      .lesson-list {
        ...
        .lesson-ele {
          ...
          .ele-bg {
            ...
            .mask {
              background: linear-gradient(180deg, transparent 0%, transparent 71.04%, #5482A3 100%);
              position: absolute;
              top: 0;
              position: absolute;
              opacity: 0;
