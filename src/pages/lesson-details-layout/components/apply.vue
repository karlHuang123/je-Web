...
export default {
  ...
  methods: {
    getAllpyList() {
      fetchGet(`/college/course-detail/course-content/get?department=${this.department}&discipline=${this.discipline}&subject=各类申请`).then(res => {
        if (res.data.data) this.applyTypeList = res.data.data
